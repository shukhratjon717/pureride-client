...
import LightweightProductsCard from './SportbikeProductsCard';
import { ProductType } from '../../../enums/property.enum';
import { Message } from '../../../enums/common.enum';
import { sweetMixinErrorAlert, sweetTopSmallSuccessAlert } from '../../../sweetAlert';
import { LIKE_TARGET_PROPERTY } from '../../../../apollo/user/mutation';

interface LightweightProductsProps {
	initialInput: ProductsInquiry;
}

const LightweightProducts = (props: LightweightProductsProps) => {
							...
							{lightweightProducts.map((property: Product) => {
								return (
									<SwiperSlide key={property._id} className="popular-property-slide">
										<LightweightProductsCard product={property} likePropertyHandler={likePropertyHandler} />
									</SwiperSlide>
								);
							})}
						</Swiper>
...
LightweightProducts.defaultProps = {
	initialInput: {
		page: 1,
		limit: 7,
		sort: 'productViews',
...
export default LightweightProducts;
