...
import { CREATE_FAQ_BY_ADMIN } from '../../../apollo/admin/mutation'; // Ensure this path is correct
  ...
  const handleCreateFaq = async () => {
    ...
    try {
      const { data, errors } = await createFaq({
        variables: {
          input: {
            ...
            faqQuestion,
            faqAnswer,
            faqStatus: 'ACTIVE', // Ensure 'ACTIVE' is a valid status
          },
        },
      });
      ...
      if (error instanceof ApolloError) {
        console.error('ApolloError message:', error.message);
